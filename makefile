...
_OBJ = notificationsystem.o achievement.o wall.o gravestone.o tree.o main.o start.o engine.o terrainobject.o avatar.o baddie.o terrainmap.o input.o display.o bullet.o
